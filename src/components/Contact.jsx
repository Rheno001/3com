              ...
              <div className="space-y-12">
                ...
                <div className="flex flex-col gap-10">
                  {[
                    ...
                    { label: 'Support Email', value: '3comcomputer@gmail.com', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg> },
                    { label: 'Our HQ', value: 'Shop No 19 Sauma Plaza, Opposite UBA Bank, Rwang Pam Street, Jos, Plateau State', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg> },
                  ].map((info, i) => (
                    <motion.div
                      key={info.label}
