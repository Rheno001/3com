              ...
              <div className="space-y-12">
                ...
                <div className="flex flex-col gap-10">
                  {[
                    ...
                    { label: 'Our HQ', value: '3com Tech Plaza, Digital City, Nigeria', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg> },
                  ].map((info, i) => (
                    <motion.div
                      key={info.label}
